...
public class AccountRecordSerializable implements Serializable
{
   ...
   // TIP.1: "instanceof" can use to make sure you don't transfer wrong object into this class.
   @Override
   public boolean equals(Object o){
	return false;
	   // TODO Override equals() to compare object is equal or not, return true if two AccountRecord has same name, else return false
	   
	}
   // ********* Do not modify anything below *****

   //Inherit from Name String hash function
  @Override
  public int hashCode(){
